...
test("website source, assets, tooling and shared configuration need validation", () => {
  for (const path of [
    ...
    "apps/web/README.md",
    "content/public-pages.ts",
    "branding/logo.json",
    "branding/statusline-symbol.svg",
    "branding/package-lock.json",
    "scripts/generate-brand-assets.mjs",
    "docs/assets/readme/app-store-qr.svg",
    "docs/assets/readme/still-signature/companion-en.png",
    "docs/assets/readme/still-signature/iphone-es.png",
...
test("unrelated changes do not rebuild the website", () => {
  const paths = [
    ...
    "docs/assets/readme/companion-data-plane.png",
