...
| StatuslineRelay            | Cloudflare Workers + D1 | Transporta blobs cifrados y aplica TTL/rate limits |
...
- Despliega un relay de producción con dominio HTTPS, D1, límites de uso y observabilidad.
